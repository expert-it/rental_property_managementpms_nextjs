    ...
    <>
      <div className="signup-main-section">
        ...
        <div className="mobile-tab-buttons text-start">
          <Button className={`login-tab ${activeForm == "login" ? "active" : ""}`} onClick={() => handleActive("login")}>Login</Button>
          <Button className={`signup-tab ${activeForm == "signup" ? "active" : ""}`} onClick={() => handleActive("signup")}>Signup</Button>
        </div>

        {activeForm == "signup" && <div className="signup-block p-4 pt-4">
          <div className="head-signup text-center">
            <h2>Signup</h2>
          </div>
          <Form noValidate validated={validated} onSubmit={handleSubmit} className="form-signup">
            <Row className="mb-3">
              ...
              <div className="error-all-fields">
                <p className="m-0"><span>Error:</span> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
              </div>
              ...
              <div className="accnt-login text-center">
                <span>Already have an account?</span> <Button onClick={() => setActiveForm("login")}>Login</Button>
              </div>
            </Row>
          </Form>
          ...
          <div className="signup-block login-block p-4 pt-4">
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit} className="form-signup">
              <Row className="mb-3">
                ...
                <Link href="#" className="text-center pt-3 text-decoration-none">
                  <span className="forgot-link">
                    Forgot Password ?
                  </span>
                </Link>
                <div className="accnt-login text-center m-0">
                  <span>Don't have an account?</span> <Button onClick={() => setActiveForm("signup")}>Signup</Button>
                </div>
              </Row>
            </Form>
            <div className="or-text-div text-center position-relative">
